...
function generateShape(response) {
    ...
    switch(response.shape) {
        case 'Triangle':
            finalShape = new Triangle(response.initials, response.textColor, response.shapeColor);
            break;
        case 'Square':
            finalShape = new Square(response.initials, response.textColor, response.shapeColor);
            break;
        case 'Circle': 
            finalShape = new Circle(response.initials, response.textColor, response.shapeColor);
        break;
    }
